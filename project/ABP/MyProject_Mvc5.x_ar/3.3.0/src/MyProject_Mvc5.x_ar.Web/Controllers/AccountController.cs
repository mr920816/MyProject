...
using MyProject_Mvc5.x_ar.Sessions;
using MyProject_Mvc5.x_ar.Web.Controllers.Results;
using MyProject_Mvc5.x_ar.Web.Models;
using MyProject_Mvc5.x_ar.Web.Models.Account;
...
{
    public class AccountController : x_arControllerBase
    {
